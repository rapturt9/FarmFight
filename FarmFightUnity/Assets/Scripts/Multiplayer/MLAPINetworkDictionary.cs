...
namespace MLAPI.NetworkVariable.Collections
{
    ...
    public class MLAPINetworkDictionary<TKey, TValue> : IDictionary<TKey, TValue>, INetworkVariable
    {
        /// <summary>
        ...
        public MLAPINetworkDictionary(NetworkVariableSettings settings)
        {
            Settings = settings;
        }
        ...
        public MLAPINetworkDictionary(NetworkVariableSettings settings, IDictionary<TKey, TValue> value)
        {
            Settings = settings;
            m_Dictionary = value;
        }
        ...
        /// </summary>
        /// <param name="value">The initial value to use for the NetworkDictionary</param>
        public MLAPINetworkDictionary(IDictionary<TKey, TValue> value)
        {
            m_Dictionary = value;
        }
